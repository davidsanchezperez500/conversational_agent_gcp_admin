resource "google_artifact_registry_repository" "repository_docker" {
  ...
  format        = "DOCKER"
  kms_key_name  = "projects/${var.project_id}/locations/${var.region}/keyRings/key-ring-artifact-repo-${var.environment}/cryptoKeys/key-artifact-repo-${var.environment}"
